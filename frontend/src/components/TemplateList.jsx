...
import { EmptyState, Modal, ModalHeader, ModalContent, TextField, TextArea } from '@vibe/core'
        ...
        <Box style={{ 
          ...
          <Flex style={{ padding: '16px 24px', borderBottom: '1px solid #E5E7EB', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
            ...
            <Flex style={{ gap: 16, alignItems: 'center' }}>
              ...
              <div style={{ width: 28, height: 28, backgroundColor: '#E2445C', borderRadius: '50%', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 'bold' }}>DS</div>
          ...
          <Flex style={{ flex: 1, overflow: 'hidden', alignItems: 'stretch' }}>
            ...
            <Box style={{ flex: 1, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
              ...
              <Flex style={{ padding: '12px 24px', borderBottom: '1px solid #E5E7EB', alignItems: 'center', gap: 12 }}>
                ...
                <Flex style={{ alignItems: 'center', gap: 8, cursor: 'pointer' }}>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2.66663 4H13.3333C14.0697 4 14.6666 4.59695 14.6666 5.33333V10.6667C14.6666 11.403 14.0697 12 13.3333 12H2.66663C1.93025 12 1.33329 11.403 1.33329 10.6667V5.33333C1.33329 4.59695 1.93025 4 2.66663 4Z" stroke="#6E7278" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M14.6666 5.33333L8.00004 8.66667L1.33337 5.33333" stroke="#6E7278" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  <Text style={{ fontSize: 14, color: '#323338' }}>Select sender account</Text>
                  <Text style={{ fontSize: 10, color: '#6E7278', marginLeft: 4 }}>▼</Text>
                </Flex>
